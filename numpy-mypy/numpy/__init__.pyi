...
def repeat(a: _ArrayLike[_S], repeats: Union[int, Sequence[int]], axis: int=None) -> _ArrayLike[_S]: ...
def squeeze(a: _ArrayLike[_S], axis: AxesType=None) -> _ArrayLike[_S]: ...
def dot(a: _ArrayLike[Any], b: _ArrayLike[Any], out: _ArrayLike[Any]=None) -> _ArrayLike[Any]: ...
def vstack(tup: Sequence[_ArrayLike[_S]]) -> _ArrayLike[_S]: ...
def hstack(tup: Sequence[_ArrayLike[_S]]) -> _ArrayLike[_S]: ...
def concatenate(s: Sequence[_ArrayLike[_S]], axis: AxesType=None) -> _ArrayLike[_S]: ...
def insert(arr: _ArrayLike[Any], obj: Union[int, Sequence[int]], values: Union[Any, _ArrayLike[Any]],
                axis: AxesType=None) -> ndarray[Any]: ...
def delete(arr: _ArrayLike[Any], obj: Union[int, Sequence[int]], axis: AxesType=None) -> _ArrayLike[Any]: ...
def diag(v: _ArrayLike[Any], k:int=None) -> ndarray[Any]: ...
def trace(a: _ArrayLike[Any], offset: int=0, axis1: int=0, axis2: int=1,
          dtype: DtypeType=None, out: _ArrayLike[_U]=None) -> _ArrayLike[Any]: ...

def sqrt(x: _ArrayLike[floating], out: _ArrayLike[_U]=None) -> _ArrayLike[floating]: ...
def square(v: _ArrayLike[Any], out: _ArrayLike[_U]=None) -> ndarray[Any]: ...
def mean(a: _ArrayLike[floating], axis: AxesType=None, dtype: Any=None,
             out: _ArrayLike[_U]=None, keepdims: bool=False) -> _ArrayLike[floating]: ...
def abs(x: _ArrayLike[complextfloating], out: ndarray[_U]=None) -> ndarray[floating]: ...
def sum(a: _ArrayLike[Any], axis: AxesType=None, dtype: DtypeType=None, out: ndarray[_U]=None,
            keepdims: bool=False) -> ndarray[Any]: ...
def diff(a: _ArrayLike[Any], n: int=1, axis: AxesType=-1) -> ndarray[Any]: ...

def save(file: Any, arr: _ArrayLike[Any], allow_pickle: bool=None, fix_imports: bool=None) -> None: ...
#args, kwargs? https://github.com/python/mypy/issues/1954
def savez(file: str, *args: Any, **kwargs: Dict[str, Any]) -> None: ...
def savez_compressed(file: str, *args: Any, **kwargs: Dict[str, Any]) -> None: ...
