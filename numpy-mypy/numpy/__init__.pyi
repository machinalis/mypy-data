...
class _ArrayLike(Generic[_S]):
    ...
    def mean(self, axis: AxesType=None, dtype: Any=None,
             out='_ArrayLike[_U]', keepdims: bool=False) -> '_ArrayLike[floating]': ...
    ...
    def __getitem__(self, key: ShapeType) -> '_ArrayLike[_S]': ...
    ...
    def __setitem__(self, key: ShapeType, value: _ArrayLike[_S]) -> None: ...
