...
class _ArrayLike(Generic[_S]):
    ...
    def mean(self, axis: AxesType=None, dtype: Any=None,
             out='_ArrayLike[_U]', keepdims: Optional[bool]=False) -> '_ArrayLike[Any]': ...
    ...
    def prod(self, axis: AxesType=None, dtype: DtypeType=None,
             out: '_ArrayLike[_U]'=None, keepdims: Optional[bool]=False) -> '_ArrayLike[Any]': ...
    ...
    def searchsorted(self, v: Union[Any, Sequence[Any]], side: Optional[str]='left',
                     sorter: Any=None) -> '_ArrayLike[int]': ...
    ...
    def var(self, axis: AxesType=None, dtype: DtypeType=None,
            out: '_ArrayLike[_U]'=None, ddof: Optional[int]=0, keepdims: Optional[bool]=False) -> '_ArrayLike[Any]': ...
    ...
    def __and__(self, value: Any) -> '_ArrayLike[int]': ...

    def __array__(self, dtype: DtypeType=None) -> '_ArrayLike[Any]': ...

    def __array_prepare__(self, context: Any=None) -> '_ArrayLike[Any]': ...

    def __array_wrap__(self, context: Any=None) -> '_ArrayLike[Any]': ...
...
def array(object: Any, dtype: Any=None, copy: Optional[bool]=True,
          order: str=None, subok: Optional[bool]=False,
...
def empty_like(a: Any, dtype: Any=None, order: Optional[str]='K',
               subok: Optional[bool]=True) -> ndarray[Any]: ...
def eye(N: int, M: int=None, k=0, dtype: Optional[DtypeType]=float) -> ndarray[Any]: ...
...
def full_like(a: Any, fill_value: Any, dtype: DtypeType=None, order: Optional[str]='C',
              subok: Optional[bool]=True) -> ndarray[Any]: ...
...
def loadtxt(fname: Any, dtype: Optional[DtypeType]=float, comments: Optional[str]='#',
            ...
            skiprows: Optional[int]=0, usecols: Sequence[int]=None,
...
def ones_like(a: Any, dtype: Any=None, order: Optional[str]='K',
              subok: Optional[bool]=True) -> ndarray[Any]: ...
def zeros(shape: ShapeType, dtype: Optional[DtypeType]=float, order: Optional[str]='C') -> ndarray[Any]: ...
def zeros_like(a: Any, dtype: Any=None, order: Optional[str]='K',
               subok: Optional[bool]=True) -> ndarray[Any]: ...
