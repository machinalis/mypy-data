...
def sqrt(x: _ArrayLike[floating], out: ndarray[_U]=None) -> ndarray[floating]: ...
def square(v: _ArrayLike[Any], out: ndarray[_U]=None) -> ndarray[Any]: ...
def mean(a: _ArrayLike[floating], axis: AxesType=None, dtype: Any=None,
             out: ndarray[_U]=None, keepdims: bool=False) -> ndarray[floating]: ...
