from typing import Any, Generic, Iterator, List, Optional, Sequence, Tuple, Type, TypeVar, Union
...
class ndarray(Generic[S]):
    ...
    def view(self, dtype: Optional[Union[_dtype, Type[NdarrayLikeType]]]=None,
