...
class _ArrayLike(Generic[_S]):
    ...
    def mean(self, axis: AxesType=None, dtype: Any=None,
             out='_ArrayLike[_U]', keepdims: bool=False) -> '_ArrayLike[Any]': ...

    def min(self, axis: AxesType=None,
            out: '_ArrayLike[_U]'=None) -> Union['_ArrayLike[_S]', '_ArrayLike[_U]']: ...

    def newbyteorder(self, new_order: str='S') -> '_ArrayLike[Any]': ...
    ...
    def put(self, ind: Sequence[Any], v: Sequence[Any], mode: str='raise') -> None: ...
    ...
    def searchsorted(self, v: Union[Any, Sequence[Any]], side: str='left',
    ...
    def tofile(self, fid: Any, sep: str='',  # TODO fix fid definition (There's a bug in mypy io's namespace https://github.com/python/mypy/issues/1462)
               format: str='%s') -> None: ...
...
def eye(N: int, M: int=None, k=0, dtype: DtypeType=float) -> ndarray[Any]: ...
...
def fromfile(file: Any, dtype: DtypeType=float, count: int=-1, sep: str='') -> ndarray[Any]: ...  # TODO fix file definition (There's a bug in mypy io's namespace https://github.com/python/mypy/issues/1462)
