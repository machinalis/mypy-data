...
class matrix(_ArrayLike[_S], Generic[_S]):
    ...
    def __init__(self, data: _ArrayLike[_S], dtype: DtypeType=None,
                 copy: bool=None) -> None: ...
...
def sqrt(x: _ArrayLike[floating], out: ndarray[_U]=None) -> ndarray[float]: ...
...
@overload
def abs(x: complextfloating, out: float=None) -> complextfloating: ...
@overload
...
def rad2deg(x: _ArrayLike[floating], out: ndarray[_U]=None) -> ndarray[float]: ...
def deg2rad(x: _ArrayLike[floating], out: ndarray[_U]=None) -> ndarray[float]: ...
def min(a: _ArrayLike[_U], axis: AxesType=None,
        out: ndarray[_U]=None) -> Union[ndarray[_S], ndarray[_U]]: ...
def max(a: _ArrayLike[_U], axis: AxesType=None,
        out: ndarray[_U]=None) -> Union[ndarray[_S], ndarray[_U]]: ...
