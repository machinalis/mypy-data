...
class _ArrayLike(Generic[_S]):
    ...
    def __iadd__(self, value: object) -> '_ArrayLike[Any]': ...

    def __iand__(self, value: object)  -> '_ArrayLike[int]': ...

    def __ifloordiv__(self, value: object) -> '_ArrayLike[int]': ...

    def __ilshift__(self, value: object) -> '_ArrayLike[_S]': ...

    def __imatmul__(self, value: '_ArrayLike[Any]') -> '_ArrayLike[Any]': ...

    def __imod__(self, value: object) -> '_ArrayLike[_S]': ...

    def __imul__(self, value: object) -> '_ArrayLike[Any]': ...
    ...
    def __ior__(self, value: object) -> '_ArrayLike[_S]': ...

    def __ipow__(self, value: object) -> '_ArrayLike[Any]': ...

    def __irshift__(self, value: object) -> '_ArrayLike[Any]': ...

    def __isub__(self, value: object) -> '_ArrayLike[Any]': ...

    def __iter__(self) -> Iterator['_ArrayLike[_S]']: ...

    def __itruediv__(sel, value: object) -> '_ArrayLike[Any]': ...

    def __ixor__(self, value: object) -> '_ArrayLike[_S]': ...
...
# matrix
#
# Note: Some the signatures don't match the actual implementation. Even though matrix says to
# inherit from ndarray, some methods have different number of arguments (like all), which shouldn't
# be possible. There's no way we can express this using type stubs, so we just overrode the methods
# restricting the types when necessary (mostly replacing ndarray or _ArrayLike for matrix):
#

class matrix(ndarray[_S], Generic[_S]):
    #
    # matrix attributes
    #
    A = None   # type: ndarray[_S]
    A1 = None  # type: ndarray[_S]
    H = None   # type: matrix[_S]
    I = None   # type: matrix[_S]
    ...
    # but it falls back to the union when it's not.
    def all(self, axis: AxesType=None, out: '_ArrayLike[_U]'=None,
            keepdims: bool=False) -> Union['matrix[_U]', 'matrix[bool]']: ...

    def any(self, axis: AxesType=None, out: '_ArrayLike[_U]'=None,
            keepdims: bool=False) -> Union['matrix[_U]', 'matrix[bool]']: ...

    def argmax(self, axis: int=None,
               out: '_ArrayLike[_U]'=None) -> Union['matrix[_U]', 'matrix[int]']: ...

    def argmin(self, axis: int=None,
               out: '_ArrayLike[_U]'=None) -> Union['matrix[_U]', 'matrix[int]']: ...

    def argpartition(self, kth: Union[int, Sequence[int]], axis: Optional[int]=-1,
                     kind: str='introselect', order: OrderType=None) -> 'matrix[int]': ...

    def argsort(self, axis: int=None, kind: str='quicksort',
                order: OrderType=None) -> 'matrix[int]': ...

    def astype(self, dtype: Any, order: str='K', casting: str='unsafe', subok: bool=True,
               copy: bool=False) -> 'matrix[Any]': ...

    def byteswap(self, inplace: bool=False) -> 'matrix[_S]': ...

    def choose(self, choices:Sequence['_ArrayLike[_V]'], out: '_ArrayLike[_U]'=None,
               mode: str='raise') ->  Union['matrix[_U]', 'matrix[_V]']: ...

    def clip(self, a_min: Any, a_max: Any,
             out: '_ArrayLike[_U]'=None) -> Union['matrix[_S]', 'matrix[_U]']: ...

    def compress(self, condition: Sequence[bool], axis: int=None,
                 out: '_ArrayLike[_U]'=None) -> Union['matrix[_S]', 'matrix[_U]']: ...

    def conj(self) -> 'matrix[_S]': ...

    def conjugate(self) -> 'matrix[_S]': ...

    def copy(self, order: str='C') -> 'matrix[_S]': ...

    def cumprod(self, axis: int=None, dtype: Any=None,
                out: '_ArrayLike[Any]'=None) -> 'matrix[Any]': ...

    def cumsum(self, axis: int=None, dtype: DtypeType=None,
                out: '_ArrayLike[Any]'=None) -> 'matrix[Any]': ...

    def diagonal(self, offset: int=0, axis1: int=0, axis2: int=1) -> 'matrix[_S]': ...

    def dot(self, b: '_ArrayLike[Any]', out: '_ArrayLike[Any]'=None) -> 'matrix[Any]': ...
    ...
    def getA(self) -> 'ndarray[_S]':...

    def getA1(self) -> 'ndarray[_S]':...

    def getH(self) -> 'matrix[_S]':...

    def getI(self) -> 'matrix[_S]':...

    def getT(self) -> 'matrix[_S]':...

    def flatten(self, order: str='C') -> 'matrix[_S]': ...

    def getfield(self, dtype: DtypeType, offset: int=0) -> 'matrix[Any]': ...
    ...
    def mean(self, axis: AxesType=None, dtype: Any=None,
             out: '_ArrayLike[_U]'=None, keepdims: bool=False) -> 'matrix[floating]': ...

    def min(self, axis: AxesType=None,
            out: '_ArrayLike[_U]'=None) -> Union['matrix[_S]', 'matrix[_U]']: ...

    def newbyteorder(self, new_order: str='S') -> 'matrix[_S]': ...
    ...
    def prod(self, axis: AxesType=None, dtype: DtypeType=None,
             out: '_ArrayLike[_U]'=None, keepdims: bool=False) -> 'matrix[Any]': ...
    ...
    def ravel(self, order: str='C') -> 'matrix[_S]': ...

    def repeat(self, repeats: Union[int, Sequence[int]],
               axis: int=None) -> 'matrix[_S]': ...

    def reshape(self, newshape: ShapeType,
                order: str='C') -> 'matrix[_S]': ...
    ...
    def searchsorted(self, v: Union[_S, '_ArrayLike[_S]'], side: str='left',
                     sorter: '_ArrayLike[int]'=None) -> 'matrix[int]': ...
    ...
    def squeeze(self, axis: AxesType=None) -> 'matrix[_S]': ...

    def std(self, axis: AxesType=None, dtype: DtypeType=None,
            out: '_ArrayLike[_U]'=None, ddof: int=0, keepdims: bool=False) -> 'matrix[floating]': ...

    def sum(self, axis: AxesType=None, dtype: DtypeType=None,
            out: '_ArrayLike[_U]'=None,
            keepdims: bool=False) -> 'matrix[Any]': ...

    def swapaxes(self, axis1: int, axis2: int) -> 'matrix[_S]': ...

    def take(self, indices: Sequence[int], axis: int=None,
             out: '_ArrayLike[_U]'=None,
             mode: str='raise') -> Union['_ArrayLike[_S]', 'matrix[_U]']: ...
    ...
    def trace(self, offset: int=0, axis1: int=0, axis2: int=1,
              dtype: DtypeType=None, out: '_ArrayLike[_U]'=None) -> 'matrix[Any]': ...

    def transpose(self, axes: Optional[AxesType]) -> 'matrix[_S]': ...

    def var(self, axis: AxesType=None, dtype: DtypeType=None,
            out: '_ArrayLike[_U]'=None, ddof: int=0, keepdims: bool=False) -> 'matrix[Any]': ...

    def view(self, dtype: Union[DtypeType, Type['ndarray']]=None,
             type: type=None) -> 'matrix[Any]': ...

    #
    # Magic methods
    #

    def __abs__(self) -> 'matrix[_S]': ...

    def __add__(self, value: object) -> 'matrix[Any]': ...

    def __and__(self, value: object) -> 'matrix[int]': ...

    def __array__(self, dtype: DtypeType=None) -> 'matrix[Any]': ...

    def __array_prepare__(self, context: object=None) -> 'matrix[Any]': ...

    def __array_wrap__(self, context: object=None) -> 'matrix[Any]': ...
    ...
    def __copy__(self) -> 'matrix[_S]': ...

    def __deepcopy__(self) -> 'matrix[_S]': ...
    ...
    def __divmod__(self, value: object) -> Tuple['matrix[int]', 'matrix[float]']: ...

    def __eq__(self, value: object) -> '_ArrayLike[bool]': ...  # type: ignore

    def __float__(self) -> float: ...

    def __floordiv__(self, value: object) -> 'matrix[int]': ...

    def __ge__(self, value: object) -> 'matrix[bool]': ...

    def __getattribute__(self, name: str) -> Any: ...

    def __getitem__(self, key: Any) -> '_ArrayLike[_S]': ...

    def __gt__(self, value: object) -> 'matrix[bool]': ...

    def __iadd__(self, value: object) -> 'matrix[Any]': ...

    def __iand__(self, value: object) -> 'matrix[int]': ...

    def __ifloordiv__(self, value: object) -> 'matrix[int]': ...

    def __ilshift__(self, value: object) -> 'matrix[_S]': ...

    def __imatmul__(self, value: '_ArrayLike[Any]') -> 'matrix[Any]': ...

    def __imod__(self, value: object) -> 'matrix[_S]': ...

    def __imul__(self, value: object) -> 'matrix[Any]': ...

    def __index__(self) -> int: ...

    def __int__(self) -> int: ...

    def __invert__(self) -> 'matrix[_S]': ...

    def __ior__(self, value: object) -> 'matrix[_S]': ...

    def __ipow__(self, value: object) -> 'matrix[Any]': ...

    def __irshift__(self, value: object) -> 'matrix[Any]': ...

    def __isub__(self, value: object) -> 'matrix[Any]': ...

    def __iter__(self) -> Iterator['_ArrayLike[_S]']: ...

    def __itruediv__(sel, value: object) -> 'matrix[Any]': ...

    def __ixor__(self, value: object) -> 'matrix[_S]': ...

    def __le__(self, value: object) -> 'matrix[bool]': ...

    def __len__(self) -> int: ...

    def __lshift__(self, value: object) -> 'matrix[_S]': ...

    def __lt__(self, value: object) -> 'matrix[bool]': ...

    def __matmul__(self, value: '_ArrayLike[Any]') -> 'matrix[Any]': ...

    def __mod__(self, value: object) -> 'matrix[_S]': ...

    def __mul__(self, value: object) -> 'matrix[Any]': ...

    def __ne__(self, value: object) -> '_ArrayLike[bool]': ...  # type: ignore

    def __neg__(self) -> 'matrix[_S]': ...

    def __or__(self, value: object) -> 'matrix[_S]': ...

    def __pos__(self) -> 'matrix[_S]': ...

    def __pow__(self, value: object) -> 'matrix[Any]': ...

    def __radd__(self, value: object) -> 'matrix[Any]': ...

    def __rand__(self, value: object) -> 'matrix[_S]': ...

    def __rdivmod__(self, value: object) -> Tuple['matrix[int]', 'matrix[float]']: ...

    def __rfloordiv__(self, value: object) -> 'matrix[Any]': ...

    def __rlshift__(self, value: object) -> 'matrix[Any]': ...

    def __rmatmul__(self, value: object) -> 'matrix[Any]': ...

    def __rmod__(self, value: object) -> 'matrix[Any]': ...

    def __rmul__(self, value: object) -> 'matrix[Any]': ...

    def __ror__(self, value: object) -> 'matrix[_S]': ...

    def __rpow__(self, value: object) -> 'matrix[Any]': ...

    def __rrshift__(self, value: object) -> 'matrix[Any]': ...

    def __rshift__(self, value: object) -> 'matrix[Any]': ...

    def __rsub__(self, value: object) -> 'matrix[Any]': ...

    def __rtruediv__(self, value: object) -> 'matrix[Any]': ...

    def __rxor__(self, value: object) -> 'matrix[_S]': ...
    ...
    def __sub__(self, value: object) -> 'matrix[Any]': ...

    def __truediv__(sel, value: object) -> 'matrix[Any]': ...

    def __xor__(self, value: object) -> 'matrix[_S]': ...
